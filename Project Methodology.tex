...
\begin{document}
\begin{align*}\section{Methods Plan}
...
\bibitem{freq_chart}
“Sound Frequency Chart,” Acoustical Solutions. [Online]. Available: https://acousticalsolutions.com/sound-frequency-chart

\bibitem{nyquist}
“Nyquist Frequency,” Wikipedia. [Online]. Available: https://en.wikipedia.org/wiki/Nyquist_frequency

\bibitem{adc}
“Analog-to-Digital Conversion,” SparkFun. [Online]. Available: https://learn.sparkfun.com/tutorials/analog-to-digital-conversion/all

\bibitem{bishop}
C. M. Bishop, \textit{Pattern Recognition and Machine Learning}. New York, NY, USA: Springer, 2006.

\end{thebibliography}\end{align*}
\end{document}